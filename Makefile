#############################################################################
# Makefile for building: flkr
# Generated by qmake (3.0) (Qt 5.4.1)
# Project:  flkr.pro
# Template: app
# Command: C:\Qt\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug -o Makefile flkr.pro
#############################################################################
...
Makefile: flkr.pro C:/Qt/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug -o Makefile flkr.pro
